package com.fernanda.controller;
...
import com.fernanda.entidade.Livro;
...
public class LivroController extends HttpServlet {
	public void doPost(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		livros.add(livro);
		String msg = String.format("Livro adicionado com sucesso, há %d livros na lista", livros.size());
